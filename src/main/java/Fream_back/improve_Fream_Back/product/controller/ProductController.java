...
public class ProductController {
     ...
     */
    @DeleteMapping
    public ResponseEntity<String> deleteProduct(@RequestBody ProductDeleteRequestDto productDeleteRequestDto) {
        String responseMessage = productService.deleteProduct(productDeleteRequestDto);
